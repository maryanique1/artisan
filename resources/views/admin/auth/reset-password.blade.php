    ...
    <style>
        * {
        ...
        .card {
            ...
            width: 100%;
            max-width: 460px;
            box-shadow: 0 12px 40px rgba(107, 45, 14, .12);
        ...
        .logo-wrap img {
            ...
            background: #fff;
            border: 1px solid var(--line);
            box-shadow: 0 3px 8px rgba(107, 45, 14, .12)
        }
        ...
        .input-wrap input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(193, 123, 78, .12)
        }
        ...
        .btn-submit {
            ...
            justify-content: center;
            gap: 8px;
            box-shadow: 0 4px 14px rgba(107, 45, 14, .3);
            margin-top: 4px
        }

        .btn-submit:hover {
            transform: translateY(-1px);
            box-shadow: 0 6px 18px rgba(107, 45, 14, .4)
        }
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $email) }}"
                        placeholder="admin@fegartisan.com" required autocomplete="email" style="padding-right:14px">
                </div>
                @error('email')
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input id="password" type="password" name="password" placeholder="Minimum 8 caractères" required
                        autocomplete="new-password" id="passInput">
