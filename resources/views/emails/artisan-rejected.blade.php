          ...
          <tr>
            <td
              ...
              <p style="color:#4A3424;font-size:.95rem;line-height:1.7;margin:0 0 24px">
                Nous avons bien examiné votre dossier de demande d'accréditation artisan sur la plateforme FeGArtisan.
                Après vérification, nous ne sommes <strong>pas en mesure de valider votre compte</strong> pour le
                moment.
              </p>

              <!-- Reason box -->
              <div
                style="background:#FEF2F2;border:1px solid #FCA5A5;border-left:4px solid #C94A3A;border-radius:10px;padding:20px 24px;margin:0 0 28px">
                <p
                  style="margin:0 0 10px;font-weight:700;color:#991B1B;font-size:.88rem;text-transform:uppercase;letter-spacing:.05em">
                  Motif du refus</p>
              ...
              <!-- What to do -->
              <div
                style="background:#FDF6EE;border:1px solid #F1E1CD;border-radius:12px;padding:24px 28px;margin:0 0 28px">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td style="padding:6px 0;color:#4A3424;font-size:.88rem">
                      <span style="color:#C17B4E;font-weight:700;margin-right:8px">1.</span> Corrigez les points
                      mentionnés ci-dessus
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:6px 0;color:#4A3424;font-size:.88rem">
                      <span style="color:#C17B4E;font-weight:700;margin-right:8px">2.</span> Mettez à jour votre profil
                      et vos documents dans l'application
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:6px 0;color:#4A3424;font-size:.88rem">
                      <span style="color:#C17B4E;font-weight:700;margin-right:8px">3.</span> Soumettez à nouveau votre
                      dossier pour une nouvelle évaluation
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <p style="color:#9A7A64;font-size:.87rem;line-height:1.6;margin:0">
                Cette décision n'est pas définitive. Vous pouvez soumettre un nouveau dossier une fois les corrections
                apportées. Notre équipe fera tout son possible pour examiner votre dossier dans les meilleurs délais.
              </p>
            </td>
          </tr>
